"""
Purpose:
- Execute the `TQL` stored procedure against SQL Server.
- Export results to the TQL Excel template.
...
TEXT_T = 'Aφορά Διακίνηση από TQL σε Παπαδά\nκαι έχει αφαιρεθεί από το suggestion'
...
stored_procedure = "TQL"
excel_path = r"\\MG-SERVER002\ShareData\reports\Πρότυπα Αρχεία\TQL.xlsx"
...
#pyinstaller --onefile TQL.py # \\MG-SERVER002\ShareData\reports\exe